...
namespace DCafe.Services
{
    ...
    public partial class RecentlyViewedProductsService : ObservableObject
    {
        ...
        public void LoadProducts()
        {
            ...
            {
                System.Diagnostics.Debug.WriteLine($"[RecentlyViewedProductsService] LoadProducts failed: {ex.Message}");
                // Clear corrupt data and start fresh
                Preferences.Remove("recently_viewed");
                RecentlyViewedProducts = new ObservableCollection<Product>();
            }
        }
